                                ...
                                <ul class="nav side-menu">
                                    ...
                                    <li><a><i class="fa fa-edit"></i> Professeur <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            ...
                                            <li><a href="ajouterProfesseur.jsp">Ajouter un professeur</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li><a><i class="fa fa-edit"></i> Etudiant <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            ...
                                            <li><a href="ajouterEtudiant.jsp">Ajouter un Etudiant</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li><a><i class="fa fa-edit"></i> Niveau <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            ...
                                            <li><a href="ajouterNiveau.jsp">Ajouter un Niveau</a></li>
                                        </ul>
                                    </li>

                                    <li><a><i class="fa fa-edit"></i> Groupe <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            <li><a href="listeGroupe.jsp">Liste des Groupes</a></li>
                                            <li><a href="ajouterGroupe.jsp">Ajouter un groupe</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li><a><i class="fa fa-edit"></i> Matiére <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            ...
                                            <li><a href="ajouterMatiere.jsp">Ajouter une matiére</a></li>
                                        </ul>
                                    </li>
            ...
            <div class="right_col" role="main">
                ...
                <div style="height:1050px;">
                    ...
                    <form method="GET" action="../../../../NiveauSer">  
                        ...
                        id : <input type="text" name="idToedit" required value="<% out.print(request.getParameter("id"));%>"  class="form-control" style="width: 400px;" ><br>
                        Libelle:      <input type="text" name="libelleToEdit" value="<% out.print(request.getParameter("libelle"));%>" required  class="form-control" style="width: 400px;"><br>
                        <input type="submit" value="Save and Return" class="btn btn-primary">
                        <%
                            request.getAttribute("id2");
                        %>
                        <a href="listeNiveau.jsp">  <input type="button" value="Cancel" class="btn btn-default"></a>
                    </form>
                </div>
