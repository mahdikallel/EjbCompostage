        ...
        <div class="container body" style="background-color: #1b6d85">
            ...
            <div class="right_col" role="main">
                ...
                <c:if test="${sessionScope.grpList == null}">
                    <%
                        GroupeServlet servlet = new GroupeServlet();
                        servlet.getList(request, response);
                        servlet.getListNivau(request, response);
                ...
                <div style="height:1050px;">
                    <h2>  Update groupe:</h2>
                    <form method="GET" action="../../../../GroupeServlet">  
                        ...
                        Nom du groupe:      <input type="text" name="nameToEdit" value="<% out.print(request.getParameter("nomgrp"));%>" required  class="form-control" style="width: 400px;"><br>
                        Abréviation:      <input type="text" name="abvToEdit" value="<% out.print(request.getParameter("abv"));%>" required  class="form-control" style="width: 400px;"><br>
                        <select name="niveau">
                        ...
                        <a href="listeGroupe.jsp">  <input type="button" value="Cancel" class="btn btn-default"></a>
                    </form>
                </div>
