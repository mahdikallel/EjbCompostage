                            ...
                            <div class="menu_section">
                                ...
                                <ul class="nav side-menu">
                                    ...
                                    <li><a><i class="fa fa-edit"></i> Etudiant <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            <li><a href="listeEtudiant.jsp">Liste des Etudiants</a></li>
                        ...
                        <form method="POST" action="../../../../MatiereServlet">
                            ...
                            <table style="width: 70%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                            <input type="number" name="vc" class="form-control" id="" value="">
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                            <input type="number" name="vtp" class="form-control" id="" value="">
                                        </div>
                                    </td>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                            <input type="number" name="vtd" class="form-control" id="" value="">
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                            <input type="number" name="coeff" class="form-control" id="" value="">
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                            <input type="number" name="cred" class="form-control" id="" value="">
                                        </div>
                                    </td>
                                </tr>
                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach items="${sessionScope.matList}" var="niv">
                                            <tr>
                                                ...
                                                <td ><a href=../../../../MatiereServlet?action=delete&idTodelete=<c:out value="${niv[0]}">  </c:out> > <input type="button"  class="btn btn-danger" value="Delete"></a> </td>

                                                    <td> 
                                                        <a href="UpdateMatiere.jsp?id=<c:url value="${niv[0]}"/>&nom=<c:url value="${niv[1]}"/>&vc=<c:url value="${niv[2]}"/>&vtp=<c:url value="${niv[3]}"/>&vtd=<c:url value="${niv[4]}"/>&coeff=<c:url value="${niv[5]}"/>&cred=<c:url value="${niv[6]}"/>" >
