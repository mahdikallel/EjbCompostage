                        ...
                        <div class="x_content">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <c:forEach items="${sessionScope.ListEtudByGroup}" var="niv">
                                    <form method="GET" action="../../../../NoteSevlet">
                                        ...
                                        <input type="text" name="id" hidden value=<c:out value="${niv[0]}" > </c:out> >
                                            ...
                                            <input hidden type="text" name="action" value="updateFromEnsNC">

                                            <input hidden type="text" name="idmat" value="<%out.print(session.getAttribute("idmat").toString());%>">
                                        <input hidden type="text" name="idgrp" value="<c:out value="${niv[10]}" ></c:out>">
                                        <input hidden type="text" name="sessionId" value="<c:out value="${niv[9]}" ></c:out>">


                                            <td><c:out value="${niv[1]}" ></c:out></td><!--NumCin-->

                                            <td><c:out value="${niv[2]}" ></c:out></td><!--Nom-->

                                            <td><c:out value="${niv[3]}" ></c:out></td><!--Prenom-->

                                            <td>
                                                <!--tp-->
                                                <input step="0.01" min="0" max="20" type="number" name="tp" class="form-control" id="" value=<c:out value="${niv[4]}" ></c:out> ></td>

                                            <td> 
                                                <!--DS-->
                                                <input step="0.01" min="0" max="20" type="number"  name="ds" class="form-control" id="" value=<c:out value="${niv[5]}" ></c:out> required></td>


                                            <td>
                                                <!--Presence-->
                                                <input step="0.01" min="0" max="20" type="number"  name="pres" class="form-control" id="" value=<c:out value="${niv[7]}" ></c:out> required>
