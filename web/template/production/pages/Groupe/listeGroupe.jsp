            ...
            <div class="right_col" role="main">
                ...
                <div style="height:1050px;">
                    <div class="x_panel">
                        ...
                        <form method="POST" action="../../../../GroupeServlet">

                            <label for="exampleInputName2"> Nom du groupe:</label>
                            <input type="text" name="nomgpr" required>
                            <input type="text" name="add" hidden value="add">
                            Abréviation:<input type="text" name="abreviation" required>
                            Niveau
                                            ...
                                            <tr>
                                                ...
                                                <td><c:out value="${niv[0]}"  ></c:out></td>
                                                 ...
                                                 <c:set var="idNiveau" value="${niv[3]}" scope="request"/>
                                                    ...
                                                    <td ><a href=../../../../GroupeServlet?action=delete&idTodelete=<c:out value="${niv[0]}">  </c:out> > <input type="button"  class="btn btn-danger" value="Delete"></a> </td>

                                                    <td> 
                                                        <a href="UpdateGroupe.jsp?id=<c:url value="${niv[0]}"/>&abv=<c:url value="${niv[2]}"/>&nomgrp=<c:url value="${niv[1]}"/>" >
