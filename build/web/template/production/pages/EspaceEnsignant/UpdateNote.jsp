                    ...
                    <form method="GET" action="../../../../NoteSevlet">
                        ...
                        <table style="width: 70%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                        <input type="" name="tp" class="form-control" id="" value="<%out.print(request.getParameter("tp"));%>">
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                        <input type="number" name="ds" class="form-control" id="" value="<%out.print(request.getParameter("ds"));%>">
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                        <input type="number" name="pres" class="form-control" id="" value="<%out.print(request.getParameter("pre"));%>">
                                    </div>
                                </td>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                        <input type="number" name="exam" class="form-control" id="" value="<%out.print(request.getParameter("exam"));%>">
                                    </div>
                                </td>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                        <input type="number" name="idcompos" class="form-control" id="" value="<%out.print(request.getParameter("compos"));%>">
                                    </div>
                                </td>
                            </tr>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select  class="form-control" required="" name="idsess">
                                                <option value="" selected> --Selectionnez la session--</option>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select  class="form-control" required="" name="idMat">
                                                <option value="" selected> --Selectionnez la matiere--</option>
                        ...
                        <a href="listeNote.jsp">  <input type="button" value="Cancel" class="btn btn-default"></a>
