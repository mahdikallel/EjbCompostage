    ...
    <body class="nav-md" style="background-color: #1b6d85" >
        <div class="container body" style="background-color: #1b6d85">
                            ...
                            <div class="menu_section">
                                ...
                                <ul class="nav side-menu">
                                    ...
                                    <li><a><i class="fa fa-edit"></i> Matiére <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            <li><a href="listeMatiere.jsp">Liste des Matiéres</a></li>
            ...
            <div class="right_col" role="main">
                <!-- top tiles -->
                <c:if test="${sessionScope.matList == null}">

                    <%
                        GroupeServlet servletGrp = new GroupeServlet();
                        servletGrp.getList(request, response);

                        ProfServlet servletProf = new ProfServlet();
                        servletProf.getList(request, response);
                    ...
                    <form method="POST" action="../../../../MatiereServlet">
                        ...
                        <table style="width: 70%">
                            <tr>
                                ...
                                <td>
                                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                        <input type="" name="id" class="form-control" id="" value="<%out.print(request.getParameter("id"));%>">
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><label for="exampleInputName2"> Libelle Matiére   :</label> </td>
                                <td>
                                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                        <input type="" name="nom" class="form-control" id="" value="<%out.print(request.getParameter("nom"));%>">
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><label for="exampleInputName2"> Volume cours :</label> </td>
                                <td>
                                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                        <input type="" name="vc" class="form-control" id="" value="<%out.print(request.getParameter("vc"));%>">
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><label for="exampleInputName2"> Volume TP  :</label> </td>
                                <td>
                                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                        <input type="" name="vtp" class="form-control" id="" value="<%out.print(request.getParameter("vtp"));%>">
                                    </div>
                                </td>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td> <label for="exampleInputName2">  Volume TD:</label> </td>
                                <td>
                                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                        <input type="" name="vtd" class="form-control" id="" value="<%out.print(request.getParameter("vtd"));%>">
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td> <label for="exampleInputName2"> Coffeicient :</label> </td>
                                <td>
                                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                        <input type="" name="coeff" class="form-control" id="" value="<%out.print(request.getParameter("coeff"));%>">
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>  <label for="exampleInputName2"> Crédit :</label> </td>
                                <td>
                                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                        <input type="" name="cred" class="form-control" id="" value="<%out.print(request.getParameter("cred"));%>">
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td><br>   <label for="exampleInputName2"> Selectionnez l'enseignant</label> </td>
                                <td>
                                    <div class="item form-group">

                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select  class="form-control" required="" name="ens">
                                                <option selected>---Choisissez l'enseignant---</option>
                        ...
                        <a href="listeMatiere.jsp">  <input type="button" value="Cancel" class="btn btn-default"></a>
