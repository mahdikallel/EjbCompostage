            ...
            <div class="right_col" role="main">
                ...
                <div style="height:1050px;">
                    ...
                    <div class="x_panel">
                        ...
                        <form method="POST" action="../../../../NiveauSer" class="form-inline">
                            <table>
                                <tr>
                                ...
                                <c:if test="${sessionScope.nivList != null}">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <c:forEach items="${sessionScope.nivList}" var="niveau">
                                                <tr>

                                                    <td><c:out value="${niveau[0]}"  ></c:out></td>

                                                        <td><c:out value="${niveau[1]}" ></c:out></td>



                                                        <td><c:out value="${niveau[2]}" ></c:out></td>

                                                        <td ><a href=../../../../NiveauSer?action=delete&idTodelete=<c:out value="${niv[0]}">  </c:out> > <input type="button"  class="btn btn-danger" value="Delete"></a> </td>
                                                        <td> 
                                                            <a href="UpdateNiveau.jsp?id=<c:out value="${niv[0]}"></c:out>&libelle=<c:out value="${niv[1]}"></c:out>" > <input type="button"  class="btn btn-warning"  value="Update"></a></td>
