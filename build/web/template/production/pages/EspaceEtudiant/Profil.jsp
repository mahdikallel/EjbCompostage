        ...
        <div class="container body" style="background-color: #1b6d85">
                                ...
                                <ul class="nav side-menu">
                                    ...
                                    <li><a><i class="fa fa-user"></i> Profil<span class="fa fa-chevron-down"></span></a>
                                       ...
                                       <c:forEach items="${sessionScope.ListMatiere}" var="niv">
                                        <li><a href="../../../../NoteSevlet?action=listNoteEtudByMat&idMat=<c:url value="${niv[6]}"/>&idEtud=<% out.print(etud.getId()); %>"><i class="fa fa-user"></i> <c:out value="${niv[0]}"></c:out><span ></span></a>
            ...
            <div class="right_col" role="main">
                ...
                <div style="height:1050px;">
                    ...
                    <c:forEach items="${sessionScope.infoEtud}" var="niv">
                        <form method="GET" action="../../../../Etudiant">
                            <input type="text" name="action" hidden value="editFromEtudiant">
